        ...
        child: new ListView(
          children: <Widget>[
            new UserAccountsDrawerHeader(
              accountName: new Text("I Made Adhikara Nugraha "),
              accountEmail: new Text("made.made.adhikara@undiksa.ac.id"),
          ...
          Container(
            ...
            child: Row(
              children: [
                ...
                Text(' Discount Cuci Gudang Up To 40%'),
              ],
            ),
          ),
//setiap bagian pada body dipisahkan container
